...
namespace TirriFashionWebJM.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Edad,Email,Telefono")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Edad,Email,Telefono")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
